...
-- =========================================
-- SOOP VIEWER STATISTICS / VERCEL CRON
-- =========================================
-- Vercel Cron이 서버에서 자동으로 현재 시청자 수를 저장합니다.
-- 브라우저에서 service_role/secret key를 사용하지 않습니다.
...
-- 시청자 샘플 INSERT는 Vercel Cron의 서버 환경변수(SUPABASE_SERVICE_ROLE_KEY)로만 수행합니다.
-- 따라서 브라우저의 anon/publishable key로 임의의 통계값을 넣을 수 없게 합니다.
