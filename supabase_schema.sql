...
-- =========================================
-- SOOP VIEWER STATISTICS
-- =========================================
-- 방송 중 사이트가 주기적으로 현재 시청자 수를 저장합니다.
-- 이 데이터로 일자별 최고/평균 시청자 그래프를 만듭니다.
...
with check (
  ...
  and viewers between 0 and 100000000
  and char_length(coalesce(broad_no, '')) <= 100
);
